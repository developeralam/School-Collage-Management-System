...
<div class="card marksheet">
	<div class="card-header">
		<h2 class="alert bg-dark text-white text-center">Student Details</h2>
	</div>
				...
				<div class="row mb-3">
					<div class="col-4">
						<div class="img-wrapper">
							<img src="{{asset('images/student/'.$students->student_photo)}}" width="100%" height="auto" alt="sdg">
							<p class="p-1 mt-1 text-white bg-primary">Student's Photo</p>
						</div>
					</div>
					
					<div class="col-4">
						<div class="img-wrapper m-auto">
							<img src="{{asset('images/student/father/'.$students->father_photo)}}" width="100%" height="auto" alt="sdg">
							<p class="p-1 mt-1 text-white bg-primary">Father's Photo</p>
						</div>
					</div>
					<div class="col-4">
						<div class="img-wrapper ml-auto">
							<img src="{{asset('images/student/mother/'.$students->mother_photo)}}" width="100%" height="auto" alt="sdg">
							<p class="p-1 mt-1 text-white bg-primary">Mother's Photo</p>
						</div>
					</div>
				</div>
				<div class="row">
