...
<div class="card">
	<div class="card-header">
		<h2 class="alert bg-dark text-white text-center">Edit Teacher</h2>
	</div>
	<div class="card-body row">
		<div class="m-auto border border-secoundary p-5 col-10">
			<form action="{{route('admin.teacher.update', $teacher->teachers_id)}}" method="post" enctype="multipart/form-data">
				@csrf
				...
				<div class="form-group">
					...
					<textarea name="address" id="address" class="form-control" cols="30" rows="10">{{$teacher->address}}</textarea>
				</div>
				<div class="form-group">
